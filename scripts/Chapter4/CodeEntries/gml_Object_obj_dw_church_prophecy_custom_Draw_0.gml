...
if (!sprite_exists(custom_sprite))
{
    ...
    gpu_set_blendmode_ext(8, bm_zero);
    ...
    else if (mode == 1)
    {
        ...
        for (var i = 0; i < array_length(sprite_string); i++)
        {
            ...
            draw_text_kern_legend(_text_x_offset, 16 + (i * 16) + 16 + 3, sprite_string[i], 1);
        }
    ...
    else if (mode == 1)
    {
        ...
        var y_offset = (16 / array_length(sprite_string));
        sprite_set_offset(custom_sprite, 0, 16 - y_offset + 16)
    }
