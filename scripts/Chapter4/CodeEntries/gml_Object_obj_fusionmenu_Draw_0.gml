...
if (type == 1 && init == 1)
{
    ...
    var topbary = 179;
    var botbary = 278;
    ossafe_fill_rectangle((camerax() + 110 - 32) - 20, cameray() + topbary, ((camerax() + 640) - 110) + 20 + 32, cameray() + topbary + 2, 0);
    ossafe_fill_rectangle((camerax() + 110 - 32) - 20, cameray() + botbary, ((camerax() + 640) - 110) + 20 + 32, cameray() + botbary + 2, 0);
    ...
    if (menu == 1)
    {
        ...
        if (alternateMenu == 0)
        {
            if (recruitPlaceable[menuCoord[1]])
            {
                if (global.is_console || obj_gamecontroller.gamepad_active)
                {
                    var button_text = stringsetloc("@    Place", "obj_fusionmenu_slash_Draw_0_gml_169_0");
                    var button_x = xx + 80;
                    
                    for (var i = 0; i < string_length(button_text); i++)
                    {
                        if (string_char_at(button_text, i + 1) == "@")
                            break;
                        
                        button_x += string_width(string_char_at(button_text, i + 1));
                    }
                    
                    draw_text(xx + 80, yy + 400, button_text);
                    draw_sprite_ext(scr_getbuttonsprite(global.input_g[4], false), 0, button_x, yy + 402, 2, 2, 0, c_white, 1);
                }
                else
                {
            ...
            if (global.is_console || obj_gamecontroller.gamepad_active)
            {
                var button_text = stringsetloc("@    Return", "obj_fusionmenu_slash_Draw_0_gml_186_0");
                var button_x = xx + 320;
                ...
                draw_text(xx + 320, yy + 400, button_text);
        ...
        {
            var button_press_text = stringsetloc("Press    @    to Return", "obj_fusionmenu_slash_Draw_0_gml_199_0");
            var button_x = xx + 80;
            var i = 0;
            
            for (i = 0; i < string_length(button_press_text); i++)
            {
                if (string_char_at(button_press_text, i + 1) == "@")
                    break;
                
                button_x += string_width(string_char_at(button_press_text, i + 1));
            }
            
            draw_text(xx + 80, yy + 400, string_hash_to_newline(button_press_text));
            draw_sprite_ext(scr_getbuttonsprite(global.input_g[5], false), 0, button_x, yy + 402, 2, 2, 0, c_white, 1);
        }
        else
        {
...
if (type == 4 && init == 1)
{
    ...
    // {
        ...
        draw_text_transformed(xx + 60, yy + 140, stringsetloc("POCKET", "obj_fusionmenu_slash_Draw_0_gml_158_0"), 1, 1, 0);
    // }
    ...
    // else
    // {
        draw_text_transformed(xx + 60, yy + 290, stringsetloc("STORAGE", "obj_fusionmenu_slash_Draw_0_gml_160_0"), 1, 1, 0);
    // }
