...
if (global.interact == 5)
{
    ...
    if (global.menuno == 2)
    {
        ...
        var weapon_str_without = stringsetsubloc("WEAPON: ~1", "", "obj_overworldc_slash_Draw_0_gml_81_0")
        var armor_str_without = stringsetsubloc("ARMOR: ~1", "", "obj_overworldc_slash_Draw_0_gml_82_0")
