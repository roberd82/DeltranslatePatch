function scr_item_localized_name_acc(argument0, argument1, argument2) //gml_Script_scr_item_localized_name_acc
{
    ...
    switch (item) {
        ...
        case 1:
            return stringsetloc(stringsetloc("Darker Candy", "scr_itemnamelist_slash_scr_itemnamelist_gml_9_0"), "scr_itemnamelist_slash_scr_itemnamelist_gml_9_1");
        ...
        case 60:
            return stringsetloc(stringsetloc("AncientSweet", "scr_itemnamelist_slash_scr_itemnamelist_gml_126_0"), "scr_itemnamelist_slash_scr_itemnamelist_gml_126_1");
        
        case 61:
            return stringsetloc(stringsetloc("Rhapsotea", "scr_itemnamelist_slash_scr_itemnamelist_gml_129_0"), "scr_itemnamelist_slash_scr_itemnamelist_gml_129_1");
        
        case 62:
            return stringsetloc(stringsetloc("Scarlixir", "scr_itemnamelist_slash_scr_itemnamelist_gml_132_0"), "scr_itemnamelist_slash_scr_itemnamelist_gml_132_1");
        
        case 63:
            return stringsetloc(stringsetloc("BitterTear", "scr_itemnamelist_slash_scr_itemnamelist_gml_135_0"), "scr_itemnamelist_slash_scr_itemnamelist_gml_135_1");
    }
    ...
    switch item {
        ...
        case 50:
            return stringsetloc(stringsetloc("Waferguard", "scr_armorinfo_slash_scr_armorinfo_gml_704_0"), "scr_armorinfo_slash_scr_armorinfo_gml_704_1");
        
        case 51:
            return stringsetloc(stringsetloc("MysticBand", "scr_armorinfo_slash_scr_armorinfo_gml_725_0"), "scr_armorinfo_slash_scr_armorinfo_gml_725_1");
        
        case 52:
            return stringsetloc(stringsetloc("PowerBand", "scr_armorinfo_slash_scr_armorinfo_gml_746_0"), "scr_armorinfo_slash_scr_armorinfo_gml_746_1");
        
        case 53:
            return stringsetloc(stringsetloc("PrincessRBN", "scr_armorinfo_slash_scr_armorinfo_gml_767_0"), "scr_armorinfo_slash_scr_armorinfo_gml_767_1");
        
        case 54:
            return stringsetloc(stringsetloc("GoldWidow", "scr_armorinfo_slash_scr_armorinfo_gml_788_0"), "scr_armorinfo_slash_scr_armorinfo_gml_788_1");
    }
    ...
    switch item {
        ...
        case 50:
            return stringsetloc(stringsetloc("JingleBlade", "scr_weaponinfo_slash_scr_weaponinfo_gml_629_0"), "scr_weaponinfo_slash_scr_weaponinfo_gml_629_1");
        
        case 51:
            return stringsetloc(stringsetloc("ScarfMark", "scr_weaponinfo_slash_scr_weaponinfo_gml_652_0"), "scr_weaponinfo_slash_scr_weaponinfo_gml_652_1");
        
        case 52:
            return stringsetloc(stringsetloc("JusticeAxe", "scr_weaponinfo_slash_scr_weaponinfo_gml_675_0"), "scr_weaponinfo_slash_scr_weaponinfo_gml_675_1");
        
        case 53:
            return stringsetloc(stringsetloc("Winglade", "scr_weaponinfo_slash_scr_weaponinfo_gml_698_0"), "scr_weaponinfo_slash_scr_weaponinfo_gml_698_1");
        
        case 54:
            return stringsetloc(stringsetloc("AbsorbAx", "scr_weaponinfo_slash_scr_weaponinfo_gml_721_0"), "scr_weaponinfo_slash_scr_weaponinfo_gml_721_1");
    }
    ...
    switch item {
        ...
        case 30:
            return stringsetloc(stringsetloc("SheetMusic", "scr_keyiteminfo_slash_scr_keyiteminfo_gml_177_0"), "scr_keyiteminfo_slash_scr_keyiteminfo_gml_177_1");
        
        case 31:
            return stringsetloc(stringsetloc("ClaimbClaws", "scr_keyiteminfo_slash_scr_keyiteminfo_gml_182_0"), "scr_keyiteminfo_slash_scr_keyiteminfo_gml_182_1");
    }
    ...
    switch item {
        ...
        case 15:
            return stringsetloc(stringsetloc("Holiday Pencil", "scr_litemname_slash_scr_litemname_gml_21_0"), "scr_litemname_slash_scr_litemname_gml_21_1");
        case 16:
            return stringsetloc(stringsetloc("CactusNeedle", "scr_litemname_slash_scr_litemname_gml_22_0"), "scr_litemname_slash_scr_litemname_gml_22_1");
        case 17:
            return stringsetloc(stringsetloc("BlackShard", "scr_litemname_slash_scr_litemname_gml_23_0"), "scr_litemname_slash_scr_litemname_gml_23_1");
        case 18:
            return stringsetloc(stringsetloc("QuillPen", "scr_litemname_slash_scr_litemname_gml_24_0"), "scr_litemname_slash_scr_litemname_gml_24_1");
    }
