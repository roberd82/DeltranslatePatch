if (!init)
{
    ...
    with (obj_marker)
    {
        ...
        if (getshad == spr_dw_churchb_npcstatue_bibliox_bake) {
            getshad = scr_84_get_sprite("spr_dw_churchb_npcstatue_bibliox_bake");
        }
        ...
        if (sprite_index == scr_84_get_sprite("spr_dw_churchb_npcstatue_bibliox_bake"))
        {
            yoff = -22;
        }
