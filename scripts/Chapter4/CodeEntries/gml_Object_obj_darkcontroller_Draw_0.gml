...
if (drawchar == 1)
{
    ...
    if (deschaver == 0)
    {
        ...
        draw_text(xx + 500, (yy + tp) - 60, string_hash_to_newline(stringsetsubloc("D$ ~1", string(global.gold), "obj_darkcontroller_slash_Draw_0_gml_47_0")));
    }
}
...
if (global.menuno == 4)
{
    ...
    draw_set_color(c_black);
    ossafe_fill_rectangle(xx + 60, yy + 90, xx + 612, yy + 410, false);
    ...
    xx_scale = min(1, 112 / string_width(statname));
    ...
    if (charcoord == 1)
    {
        ...
        else
        {
            ...
            {
                draw_set_color(-1);
                xx_scale = min(1, 122 / string_width(readstring));
                draw_text_transformed(xx + 100, ch_y[4], readstring, xx_scale, 1, 0);
    ...
    if (charcoord == 3)
    {
        ...
        var statname = stringsetloc("Fluffiness", "obj_darkcontroller_slash_Draw_0_gml_286_0")
        var xx_scale = min(1, 122 / string_width(statname))
    ...
    for (var i = 0; i < 6; i += 1)
    {
        if (global.spell[charcoord][i] > 0)
        {
            ...
            draw_text(xx + 340 + 42, ch_y[i], string_hash_to_newline(tpcoststring));
            draw_set_halign(fa_left);
...
if (global.menuno == 2)
{
    ...
    ossafe_fill_rectangle(xx + 59, yy + 221, (xx + 628) - 4, yy + 221 + 5, false);
...
if (global.menuno == 1)
{
    var xx_off = -24
    draw_set_color(c_black);
    ossafe_fill_rectangle(xx + 70 + xx_off, yy + 90, xx + 570 - xx_off, yy + 360, false);
    ...
    {
        draw_set_color(c_white);
        draw_text(xx + 20, yy + 10, string_hash_to_newline(stringsetsubloc("Really throw away the#~1?", scr_item_localized_name_acc(global.item[global.submenucoord[2]], 0), "obj_darkcontroller_slash_Draw_0_gml_956_0")));
    }
