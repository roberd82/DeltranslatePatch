function scr_init_localization()
{
    ...
    if (global.lang_loaded != global.lang)
    {
        ...
        global.chapter_lang_settings = scr_load_json(global.lang_folder + global.lang + "/chapter4/chapter_settings.json");
