function add_sprite(argument0, argument1) //gml_Script_add_sprite
{
    ...
    var frame_num = 0
    var filename = working_directory + "../lang/" + global.lang + "/chapter4/sprites/" + spr_name + ".png"
    if file_exists(filename)
    {
        ...
        var sp_filename = working_directory + "../lang/" + global.lang + "/chapter4/sprites/sp_" + spr_name + ".png"
        ...
        var spm_filename = working_directory + "../lang/" + global.lang + "/chapter4/sprites/spm_" + spr_name + ".png"
