...
if (MyTurn == 1)
{
    ...
    {
        var button_text = stringsetloc("* Claim with    @", "obj_rouxls_simtown_slash_Draw_0_gml_103_0")
        var button_x = base_xpos + 66
        ...
        draw_text((base_xpos + 66), (base_ypos + 387), button_text)

        draw_sprite_ext(scr_getbuttonsprite(global.input_g[4], false), 0, button_x, (base_ypos + 391), 2, 2, 0, c_white, 1)
    }
    else
