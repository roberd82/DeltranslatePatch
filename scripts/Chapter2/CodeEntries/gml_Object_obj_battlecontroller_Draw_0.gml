...
if (global.bmenuno == 1 || global.bmenuno == 3 || global.bmenuno == 11 || global.bmenuno == 12 || global.bmenuno == 13)
{
    if (global.myfight == 0)
    {
        draw_sprite(spr_heart, 0, xx + 15, yy + 385 + (global.bmenucoord[global.bmenuno][global.charturn] * 30));
        ...
        for (i = 0; i < 3; i += 1)
        {
            ...
            if (global.monster[i] == 1)
            {
                ...
                if (tireddraw == 1)
                {
                    ...
                    draw_sprite(scr_84_get_sprite("spr_tiredmark"), 0, xx + 40 + namewidth + 30, yy + 385 + (i * 30));
                }
                ...
                if (mercydraw == 1)
                {
                    ...
                    if (hidemercy == 0)
                        draw_sprite(spr_sparestar, 0, xx + 40 + namewidth + 10, yy + 385 + (i * 30));
                }
                
                draw_text_colour(xx + 40, yy + 375 + (i * 30), string_hash_to_newline(global.monstername[i]), mnamecolor1, mnamecolor2, mnamecolor2, mnamecolor1, 1);
                var __drawstatus = 0;
                ...
                if (__drawstatus == 0)
                {
                    ...
                    var x_scale = min(1, (415 - (40 + namewidth + 50)) / string_width(global.monstercomment[i]));
                    draw_text_transformed(xx + 40 + namewidth + 50, yy + 375 + (i * 30), string_hash_to_newline(global.monstercomment[i]), x_scale, 1, 0);
                ...
                else
                {
                    ...
                    draw_text_width(xx + 40 + namewidthmax + 60, yy + 375 + (i * 30), string_hash_to_newline(__actname), 514 - (40 + namewidthmax + 60));
                }
...
if (global.bmenuno == 2 && global.myfight == 0 && global.flag[34] == 1)
{
    ...
    draw_text(xx + spell_offset, yy + 440, string_hash_to_newline(string(thiscost) + stringsetloc("% TP", "obj_battlecontroller_slash_Draw_0_gml_0_0")));
}
...
if (global.bmenuno == 9 && global.myfight == 0)
{
    ...
    for (i = 0; i < 6; i += 1)
    {
        ...
        if (chartime == 2)
            draw_sprite_ext(scr_84_get_sprite("spr_headsusie"), 0, xx + 30 + xoffset, yy + 375 + yoffset, 1, 1, 0, susblend, 1);
        
        if (chartime == 3)
            draw_sprite_ext(scr_84_get_sprite("spr_headralsei"), 0, xx + 30 + xoffset, yy + 375 + yoffset, 1, 1, 0, susblend, 1);
        
        if (chartime == 4)
        {
            draw_sprite_ext(scr_84_get_sprite("spr_headsusie"), 0, xx + 30 + xoffset, yy + 375 + yoffset, 1, 1, 0, susblend, 1);
            draw_sprite_ext(scr_84_get_sprite("spr_headralsei"), 0, xx + 60 + xoffset, yy + 375 + yoffset, 1, 1, 0, susblend, 1);
        }
        
        if (chartime == 5)
            draw_sprite_ext(scr_84_get_sprite("spr_headnoelle"), 0, xx + 30 + xoffset, yy + 375 + yoffset, 1, 1, 0, noeblend, 1);
        ...
        if (global.chapter == 2 && instance_exists(obj_spamton_neo_enemy) && obj_spamton_neo_enemy.savemeactcon > 0)
        {
            if (obj_spamton_neo_enemy.savemeactcon == 1)
                draw_sprite_ext(scr_84_get_sprite("spr_headralsei"), 0, xx + 30, yy + 380, 1, 1, 0, noeblend, 1);
            
            if (obj_spamton_neo_enemy.savemeactcon == 2)
                draw_sprite_ext(scr_84_get_sprite("spr_headralsei"), 0, xx + 30, yy + 380, 1, 1, 0, noeblend, 1);
            
            if (obj_spamton_neo_enemy.savemeactcon == 3)
                draw_sprite_ext(scr_84_get_sprite("spr_headsusie"), 0, xx + 30, yy + 380, 1, 1, 0, noeblend, 1);
            
            if (obj_spamton_neo_enemy.savemeactcon == 4)
                draw_sprite_ext(scr_84_get_sprite("spr_headsusie"), 0, xx + 30, yy + 380, 1, 1, 0, noeblend, 1);
            
            if (obj_spamton_neo_enemy.savemeactcon > 4)
                draw_sprite_ext(scr_84_get_sprite("spr_headnoelle"), 0, xx + 30, yy + 380, 1, 1, 0, noeblend, 1);
        }
    ...
    if (global.tensionselect > 0)
    {
        ...
        draw_set_color(c_orange);
        draw_text(xx + 500, yy + 440, string_hash_to_newline(string(thiscost) + stringsetloc("% TP", "obj_battlecontroller_slash_Draw_0_gml_0_0")));
    }
    ...
    if (global.myfight == 0)
    {
        ...
        for (i = 0; i < 3; i += 1)
        {
            if (global.char[i] != 0)
            {
                ...
                draw_set_color(c_white);
                draw_text(xx + 40, yy + 375 + (i * 30), string_hash_to_newline(global.charname[global.char[i]]));
                draw_set_color(c_maroon);
        ...
        if (global.bmenuno == 11 || global.bmenuno == 13 || global.bmenuno == 2)
        {
            ...
            for (i = 0; i < 3; i++)
            {
                ...
                if (global.monster[i])
                {
                    ...
                    if (__y > 0)
                        draw_rectangle((global.monsterx[i] - 210) + __offsetx, global.monstery[i] + __offsety, (global.monsterx[i] - 40) + __x + __offsetx, global.monstery[i] + __y + __offsety, true);
                }
            }
...
if (global.myfight == 0 && global.chapter == 2 && instance_exists(obj_queen_enemy) && (global.bmenuno == 1 || global.bmenuno == 3 || global.bmenuno == 11 || global.bmenuno == 12 || global.bmenuno == 13))
{
    ...
    {
        draw_set_color(c_gray);
        draw_text_ext_transformed(__view_get(0, 0) + 40, __view_get(1, 0) + 407, stringsetloc("Berdly", "obj_battlecontroller_slash_Draw_0_gml_653_0"), 9999, 9999, 1, 1, 0);
        draw_set_color(c_white);
        draw_healthbar(__view_get(0, 0) + 520, __view_get(1, 0) + 418, __view_get(0, 0) + 600, __view_get(1, 0) + 433, obj_queen_enemy.bardlymercy, c_gray, c_yellow, c_yellow, 0, 1, 0);
    }
    else
    {
        draw_set_color(c_gray);
        draw_text_ext_transformed(__view_get(0, 0) + 40, __view_get(1, 0) + 407, stringsetloc("Shield", "obj_queen_enemy_slash_Draw_0_gml_67_0"), 9999, 9999, 1, 1, 0);
        draw_set_color(c_white);
        draw_healthbar(__view_get(0, 0) + 520, __view_get(1, 0) + 418, __view_get(0, 0) + 600, __view_get(1, 0) + 433, (obj_queen_enemy.shieldacthp / obj_queen_enemy.shieldactmaxhp) * 10, c_gray, c_yellow, c_yellow, 0, 1, 0);
    }
    ...
    if (global.lang != "ja")
    {
        if (obj_queen_enemy.shieldhp > 1)
            draw_text_ext_transformed(__view_get(0, 0) + 210 + xx2, __view_get(1, 0) + 376, stringsetloc("(Protected)", "obj_queen_enemy_slash_Draw_0_gml_78_0"), 9999, 9999, 1, 1, 0);
        else
            draw_text_ext_transformed(__view_get(0, 0) + 210 + xx2, __view_get(1, 0) + 376, stringsetloc("(Defenseless)", "obj_queen_enemy_slash_Draw_0_gml_82_0"), 9999, 9999, 1, 1, 0);
    }
}
