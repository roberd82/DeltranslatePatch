...
if (type == 1 && init == 1)
{
    ...
    var topbary = 179;
    var botbary = 278;
    draw_rectangle((camerax() + 110 - 32) - 20, cameray() + topbary, ((camerax() + 640) - 110) + 20 + 32, cameray() + topbary + 2, 0);
    draw_rectangle((camerax() + 110 - 32) - 20, cameray() + botbary, ((camerax() + 640) - 110) + 20 + 32, cameray() + botbary + 2, 0);
