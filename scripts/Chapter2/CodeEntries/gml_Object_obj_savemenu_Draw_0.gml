...
if (menuno == 0)
{
    ...
    draw_text((60 * d) + xx, (60 * d) + yy, string_hash_to_newline((name_current == "[EMPTY]" ? stringsetloc("[EMPTY]", "DEVICE_MENU_slash_Step_0_gml_105_0") : name_current)));
...
else if (menuno == 1)
{
    ...
    for (var i = 0; i < 3; i++)
    {
        ...
        if (level_file[i] != 0)
        {
            ...
            draw_text(camerax() + 320, cameray() + my + 20 + (i * mspace), (name_file[i] == "[EMPTY]" ? stringsetloc("[EMPTY]", "DEVICE_MENU_slash_Step_0_gml_105_0") : name_file[i]));
            draw_set_halign(fa_left);
            draw_set_color(c_white);
        }
        else
    ...
    if (overwrite == 1)
    {
        ...
        draw_text(camerax() + 320, (15 + cameray() + 180) - 30, (name_file[mpos] == "[EMPTY]" ? stringsetloc("[EMPTY]", "DEVICE_MENU_slash_Step_0_gml_105_0") : name_file[mpos]));
        draw_set_halign(fa_left);
        draw_set_color(c_white);
