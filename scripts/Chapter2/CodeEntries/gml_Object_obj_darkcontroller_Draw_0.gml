...
if (global.menuno == 4)
{
    ...
    if (global.submenu == 21)
        draw_sprite(spr_heart, 0, (xx + 320 + 42) - string_width(string(round((global.spellcost[charcoord][global.submenucoord[21]] / global.maxtension) * 100)) + "%"), yy + 240 + (global.submenucoord[21] * 25));
