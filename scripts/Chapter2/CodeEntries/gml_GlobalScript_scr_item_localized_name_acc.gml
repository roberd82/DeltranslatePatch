function scr_item_localized_name_acc(argument0, argument1, argument2) //gml_Script_scr_item_localized_name_acc
{
    ...
    switch (item) {
        ...
        case 18:
            return stringsetloc(stringsetloc("Kris Tea", "scr_itemnamelist_slash_scr_itemnamelist_gml_59_0"), "scr_itemnamelist_slash_scr_itemnamelist_gml_59_1")
        case 19:
            return stringsetloc(stringsetloc("Noelle Tea", "scr_itemnamelist_slash_scr_itemnamelist_gml_62_0"), "scr_itemnamelist_slash_scr_itemnamelist_gml_62_1")
        case 20:
            return stringsetloc(stringsetloc("Ralsei Tea", "scr_itemnamelist_slash_scr_itemnamelist_gml_65_0"), "scr_itemnamelist_slash_scr_itemnamelist_gml_65_1")
        case 21:
            return stringsetloc(stringsetloc("Susie Tea", "scr_itemnamelist_slash_scr_itemnamelist_gml_68_0"), "scr_itemnamelist_slash_scr_itemnamelist_gml_68_1")
        case 22:
