function scr_init_localization()
{
    ...
    if (global.lang_loaded != global.lang)
    {
        ...
        global.chapter_lang_settings = scr_load_json(working_directory + "../lang/" + global.lang + "/chapter2/chapter_settings.json");
        ...
        global.songs_list = ["ch2_credits.ogg", "spamton_battle.ogg", "spamton_meeting.ogg", "spamton_neo_mix_ex_wip.ogg", "snd_tm_quiz_a", "snd_tm_quiz_b", "snd_tm_quiz_c", "snd_tm_quiz_d", "snd_boxing_fight", "snd_boxing_fight_bc", "snd_boxing_round1", "snd_boxing_round1_bc", "snd_boxing_round2", "snd_boxing_round2_bc", "snd_boxing_round3", "snd_boxing_round3_bc"];
