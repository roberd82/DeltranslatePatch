function scr_teevie_quiz(arg0)
{
    ...
    switch (quiz_id)
    {
        ...
        case "B":
            ...
            var fake_answer = (rank_1_letter == rank_2_letter) ? stringsetloc("B", "scr_get_rank_letter_slash_scr_get_rank_letter_gml_5_3") : rank_2_letter;
            
            if (fake_answer == rank_1_letter)
                fake_answer = stringsetloc("C", "scr_get_rank_letter_slash_scr_get_rank_letter_gml_5_4");
        ...
        case "C":
            ...
            if (_question_type == 0)
            {
                ...
                if (_type == 1)
                {
                    ...
                    correct_answer[0] = (_answer_a > _answer_b) ? let_a : let_b;
                    max_time_limit[0] = 50;
                    question_visual[0] = "none";
                }
                else
