...
init = function(arg0)
{
    ...
    switch (arg0)
    {
        ...
        case "yak":
            prize_x_offset = -280;
            prize_sprite = scr_84_get_sprite("spr_dw_tv_prize_talkback");
            pippins_x = -170;
            pippins_y = 100;
            break;
        
        case "sink":
            prize_sprite = scr_84_get_sprite("spr_dw_tv_prize_sink");
            prize_x_offset = -200;
            prize_y_offset = 60;
            pippins_x = -120;
            pippins_y = 70;
        ...
        case "curtain":
            prize_sprite = scr_84_get_sprite("spr_dw_tv_prize_curtain");
            prize_x_offset = -140;
            pippins_x = 20;
            pippins_y = 100;
            break;
        ...
        case "gum":
            prize_sprite = scr_84_get_sprite("spr_dw_tv_prize_gum");
            pippins_x = 90;
            pippins_y = 100;
            break;
        
        default:
            prize_sprite = spr_treasurebox;
