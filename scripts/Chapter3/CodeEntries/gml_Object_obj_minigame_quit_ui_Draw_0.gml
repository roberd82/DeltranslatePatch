...
quistring2 = stringsetloc("Hold      : Quit", "obj_minigame_quit_ui_slash_Draw_0_gml_19_0");
_quistring_quit = stringsetloc("     : Quit", "obj_minigame_quit_ui_slash_Draw_0_gml_19_1");
quistring3 = stringsetsubloc("~1 : Quit", scr_get_input_name(6), "obj_minigame_quit_ui_slash_Draw_0_gml_20_0");

if (room == room_dw_susiezilla) {
    quistring = quistring3;
    quistring2 = _quistring_quit
}
...
if (global.is_console || obj_gamecontroller.gamepad_active)
{
    ...
    var butxoff = (camerax() + 720) - (_easedLerp * 100) - string_width(_quistring_quit);
    var butxpos = (camerax() + 720) - (_easedLerp * 100) - string_width(quistring2) - 4;
