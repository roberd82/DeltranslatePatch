...
{
    draw_sprite_ext(scr_84_get_sprite("spr_gameshow_screen_city"), 0, camerax() + 128, cameray() + 48, 2, 2, 0, c_white, 1);
}
...
{
    screen_anim += screen_anim_speed;
    draw_sprite_ext(scr_84_get_sprite("spr_gameshow_screen_logo"), screen_anim, camerax() + 160, cameray() + 64, 2, 2, 0, merge_color(c_white, c_blue, 0.5), 0.5);
}
...
if (screen_state == "round_complete")
{
    ...
    var w = string_width(roundtext) + string_width(compltext) + 32;
    var xx_st = xx_mid - (w / 2);
    var xx_rt = xx_st + string_width(roundtext) + 16;
    var xx_ct = xx_st + string_width(roundtext) + 32;
    var squishamt = 12;
    custom_text_timer++;
    var coltime = 15;
    ...
    draw_text_transformed_color(xx_rt + shadoff + round_offset_x, (yy - 14) + shadoff + round_offset_y, round_text, 2, 2, 0, shadcolor, shadcolor, shadcolor, shadcolor, shadalph);
    draw_text_transformed_color(xx_rt + round_offset_x, (yy - 14) + round_offset_y, round_text, 2, 2, 0, _col, _col, _col2, _col2, 1);
    draw_set_halign(fa_left);
    draw_text_transformed_color(xx_st + shadoff, yy + shadoff, roundtext, 1, 1, 0, shadcolor, shadcolor, shadcolor, shadcolor, shadalph);
    draw_set_color(c_white);
    draw_text(xx_st, yy, roundtext);
    draw_text_transformed_color(xx_ct + shadoff, yy + shadoff, compltext, 1, 1, 0, shadcolor, shadcolor, shadcolor, shadcolor, shadalph);
    draw_set_color(c_white);
    draw_text(xx_ct, yy, compltext);
    ...
    if (screen_sub_state == "next_board_2")
    {
        ...
        draw_set_halign(fa_center);
        draw_text_transformed_color(xx_mid + shadoff + complete_offset_x, yy + (mspace * 1) + shadoff + complete_offset_y, text_next, 1, 1, 0, shadcolor, shadcolor, shadcolor, shadcolor, shadalph);
        draw_set_color(c_white);
        draw_text(xx_mid + complete_offset_x, yy + (mspace * 1) + complete_offset_y, text_next);
        var _yloc = yy + 36;
        draw_text_transformed_color(xx_mid + shadoff, _yloc + shadoff, stringsetsubloc("~1 2", text_round, "obj_dw_gameshow_screen_slash_Draw_0_gml_130_0"), 2, 2, 0, shadcolor, shadcolor, shadcolor, shadcolor, shadalph);
        draw_text_transformed_color(xx_mid, _yloc, stringsetsubloc("~1 2", text_round, "obj_dw_gameshow_screen_slash_Draw_0_gml_130_0"), 2, 2, 0, _col2, _col, _col2, _col, 1);
        draw_set_halign(fa_left);
    }
    else
    {
        ...
        var complete_offset_y = 0;
        draw_set_halign(fa_center);
        draw_text_transformed_color(xx_mid + shadoff + complete_offset_x, yy + (mspace * 1) + shadoff + complete_offset_y, roundcompletetext15, 1, 1, 0, shadcolor, shadcolor, shadcolor, shadcolor, shadalph);
        draw_set_color(c_white);
        draw_text(xx_mid + complete_offset_x, yy + (mspace * 1) + complete_offset_y, roundcompletetext15);
        var _yloc = yy + 36;
        draw_text_transformed_color(xx_mid + shadoff, _yloc + shadoff, stringsetsubloc("~1!!", rank_text, "obj_dw_gameshow_screen_slash_Draw_0_gml_131_0"), 2, 2, 0, shadcolor, shadcolor, shadcolor, shadcolor, shadalph);
        draw_text_transformed_color(xx_mid, _yloc, stringsetsubloc("~1!!", rank_text, "obj_dw_gameshow_screen_slash_Draw_0_gml_131_0"), 2, 2, 0, c_yellow, c_yellow, c_white, c_white, 1);
        draw_set_halign(fa_left);
    }
    ...
    if (screen_sub_state == "breaking")
    {
        ...
        scr_draw_sprite_tiled_area(scr_84_get_sprite("spr_dw_gameshow_screen_news"), 0, camerax() + 120 + news_speed, cameray() + 48, camerax() + 120, cameray() + 48, camerax() + 532, cameray() + 48 + 16, 1, 1, c_white, 1);
        scr_draw_sprite_tiled_area(scr_84_get_sprite("spr_dw_gameshow_screen_news"), 0, camerax() + 120 + news_speed, cameray() + 212, camerax() + 120, cameray() + 212, camerax() + 532, cameray() + 212 + 16, 1, 1, c_white, 1);
    }
...
if (screen_state == "round_complete_2")
{
    ...
    if (screen_sub_state == "bonus_board")
    {
        ...
        var _col = merge_color(c_white, c_yellow, abs(sin(custom_text_timer / coltime)));
        var _col2 = merge_color(c_yellow, c_white, abs(sin((custom_text_timer + (coltime / 2)) / coltime)));
        draw_text_transformed_color(xx + shadoff, yy + 54 + shadoff, stringsetsubloc("~1 3", text_round, "obj_dw_gameshow_screen_slash_Draw_0_gml_132_0"), 2, 2, 0, shadcolor, shadcolor, shadcolor, shadcolor, shadalph);
        draw_text_transformed_color(xx, yy + 54, stringsetsubloc("~1 3", text_round, "obj_dw_gameshow_screen_slash_Draw_0_gml_132_0"), 2, 2, 0, _col2, _col, _col2, _col, 1);
    ...
    {
        draw_set_halign(fa_center);
        draw_text_transformed_color(xx + shadoff, ((yy + 40) - 4) + shadoff, stringsetsubloc("~1!!", rank_text, "obj_dw_gameshow_screen_slash_Draw_0_gml_131_0"), 2, 2, 0, shadcolor, shadcolor, shadcolor, shadcolor, shadalph);
        draw_text_transformed_color(xx, (yy + 40) - 4, stringsetsubloc("~1!!", rank_text, "obj_dw_gameshow_screen_slash_Draw_0_gml_131_0"), 2, 2, 0, c_yellow, c_yellow, c_white, c_white, 1);
        draw_set_halign(fa_left);
    }
...
if (screen_state == "board_bonus")
{
    ...
    var _base_y_pos = (cameray() + (view_hport[0] / 2)) - 140;
    draw_text_transformed(_base_x_pos, _base_y_pos, stringsetsubloc("~1 3", text_round, "obj_dw_gameshow_screen_slash_Draw_0_gml_132_0"), 1.6, 1.3, 0);
...
if (screen_state == "board_bonus_bonus")
{
    if (!sprite_exists(bonus_confirmed_sprite))
    {
        ...
        draw_set_valign(fa_top);
        draw_set_font(scr_84_get_font("8bit"));
        var text_scale = min(1, string_width("BONUS ROUND") / string_width(text_bonus_round));
        draw_text_transformed(x, y, text_bonus, text_scale * 1.6, 1.3, 0);
        draw_text_transformed(x, y + 18, text_bonus_round, text_scale * 1.6, 1.3, 0);
        draw_text_transformed(x, y + 18 + 18, text_confirmed, text_scale * 1.6, 1.3, 0);
        ...
        draw_set_valign(fa_top);
        surface_reset_target();
        bonus_confirmed_sprite = sprite_create_from_surface(bg_surface, x - (string_width(text_bonus_round) * 1.6), y, x + (string_width(text_bonus_round) * 1.6), y + 54, false, true, 0, 0);
        sprite_set_offset(bonus_confirmed_sprite, sprite_get_width(bonus_confirmed_sprite) / 2, sprite_get_height(bonus_confirmed_sprite) / 2);
        surface_free(bg_surface);
    }
    else
    {
...
if (screen_state == "bonus_confirmed")
{
    if (!sprite_exists(bonus_confirmed_sprite))
    {
        ...
        draw_set_font(scr_84_get_font("8bit"));
        var text_scale = min(1, string_width("BONUS ROUND") / string_width(text_bonus_round));
        var xx = camera_get_view_width(0) / 2;
        draw_text_transformed(xx, y, text_bonus_round, 0.8 * text_scale, 1.3, 0);
        draw_text_transformed(xx, y + 24, text_confirmed, 0.8 * text_scale, 1.3, 0);
        
        for (var i = 0; i < 7; i++)
            draw_sprite_ext(spr_board_battle_results_exclamation, 0, (xx - 44) + (14 * i), y + 40 + 10.1, 2, 2, 0, c_white, 1);
        
        draw_set_halign(fa_left);
        draw_set_valign(fa_top);
        surface_reset_target();
        bonus_confirmed_sprite = sprite_create_from_surface(bg_surface, 0, y, camera_get_view_width(0), y + 54, false, true, 0, 0);
