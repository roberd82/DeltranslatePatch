if (i_ex(mywriter))
{
    ...
    if (reformatted == 0)
    {
        ...
        if (mywriter.formatted == 1)
        {
            ...
            widthmax = mywriter.widthmax;
            limit_by_width = mywriter.limit_by_width;
            hspace = mywriter.hspace;
            vspace = mywriter.vspace;
            linecount = mywriter.linecount;
            if (limit_by_width) {
                balloonwidth = widthmax + 10;
            } else {
    ...
    if (auto_length == 1 && init == 1)
    {
        ...
        if (side == 3)
            draw_sprite_ext(spr_battleblcon_parts, 4, x + balloonwidth / 2, y - 21, 1, 1, 90, c_white, 1);
