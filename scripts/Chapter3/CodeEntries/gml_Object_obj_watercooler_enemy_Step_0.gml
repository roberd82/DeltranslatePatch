...
if (global.monster[myself] == 1)
{
    if (scr_isphase("enemytalk") && talked == 0)
    {
        ...
        if (amimoonwarmer == false)
        {
            var vowel_arr = []
            var i = 0
            while (!is_undefined(ds_map_find_value(global.lang_map, "obj_watercooler_enemy_slash_Step_0_gml_35_" + string(i)))) {
                if (i == 2) {
                    for (var j = 0; j < 2; j++) {
                        vowel_arr[i] = stringsetloc("", "obj_watercooler_enemy_slash_Step_0_gml_35_" + string(i));
                    }
                }
                vowel_arr[i] = stringsetloc("", "obj_watercooler_enemy_slash_Step_0_gml_35_" + string(i));
                i++
            }
            if (array_length(vowel_arr) == 0) {
                vowel_arr = ["a", "e", "i", "o", "u", "u", "oo"];
            }

            var vowel_arr2 = []
            i = 0
            while (!is_undefined(ds_map_find_value(global.lang_map, "obj_watercooler_enemy_slash_Step_0_gml_36_" + string(i)))) {
                vowel_arr2[i] = stringsetloc("", "obj_watercooler_enemy_slash_Step_0_gml_36_" + string(i));
                i++
            }
            if (array_length(vowel_arr2) == 0) {
                vowel_arr2 = ["i", "l"];
            }
            // choose("i", "l")
            var random_vowel = vowel_arr[irandom(array_length(vowel_arr) - 1)];
            var random_vowel2 = vowel_arr2[irandom(array_length(vowel_arr2) - 1)];
            ...
            if (rr == 1)
                ...
                msgsetsubloc(0, "B~1b~2e", random_vowel, random_vowel2, "obj_watercooler_enemy_slash_Step_0_gml_38_0");
        }
        else if (rr == 1)
        {
        ...
        else
        {
            var vowel_arrs = [[], [], []]
            var i = 0
            while (!is_undefined(ds_map_find_value(global.lang_map, "obj_watercooler_enemy_slash_Step_0_gml_39_" + string(i)))) {
                vowel_arrs[0][i] = stringsetloc("", "obj_watercooler_enemy_slash_Step_0_gml_39_" + string(i));
                i++
            }
            i = 0
            while (!is_undefined(ds_map_find_value(global.lang_map, "obj_watercooler_enemy_slash_Step_0_gml_40_" + string(i)))) {
                vowel_arrs[1][i] = stringsetloc("", "obj_watercooler_enemy_slash_Step_0_gml_40_" + string(i));
                i++
            }
            i = 0
            while (!is_undefined(ds_map_find_value(global.lang_map, "obj_watercooler_enemy_slash_Step_0_gml_41_" + string(i)))) {
                vowel_arrs[2][i] = stringsetloc("", "obj_watercooler_enemy_slash_Step_0_gml_41_" + string(i));
                i++
            }
            if (array_length(vowel_arrs[0]) == 0) {
                vowel_arrs[0] = ["N", "M", "M"];
            }
            if (array_length(vowel_arrs[1]) == 0) {
                vowel_arrs[1] = ["o", "oo", "a", "o", "oo"];
            }
            if (array_length(vowel_arrs[2]) == 0) {
                vowel_arrs[2] = ["n", "m", "no", "mo", "n", "m"];
            }
            var random_message = 
                vowel_arrs[0][irandom(array_length(vowel_arrs[0]) - 1)] + 
                vowel_arrs[1][irandom(array_length(vowel_arrs[1]) - 1)] + 
                vowel_arrs[2][irandom(array_length(vowel_arrs[2]) - 1)]
                
            msgset(0, random_message);
        }
