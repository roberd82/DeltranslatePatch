...
var _norank = stringsetloc("NO RANK", "obj_round_evaluation_slash_Draw_0_gml_32_0");
...
if (con >= 1)
{
    ...
    if (replayversion && boardnumber == 3)
    {
        ...
        if (gradecon >= 1)
        {
            ...
            draw_set_font(scr_84_get_font("8bit"));
            draw_set_halign(fa_center);
            draw_text_transformed_color(midx + shadoff, yy + (mspace * 4) + 20 + shadoff, get_letter_rank(currentphysgrade), 4, 4, 0, shadcolor, shadcolor, shadcolor, shadcolor, shadalph);
            draw_text_transformed_color(midx, yy + (mspace * 4) + 20, get_letter_rank(currentphysgrade), 4, 4, 0, _col, _col, c_white, c_white, 1);
            draw_set_font(scr_84_get_font("8bit_mixed"));
        }
    ...
    if (replayversion && boardnumber == 2)
    {
        ...
        if (gradecon >= 1)
        {
            ...
            draw_set_font(scr_84_get_font("8bit"));
            draw_set_halign(fa_center);
            draw_text_transformed_color(320 + shadoff, yy + (mspace * 6) + shadoff + 10, get_letter_rank(currentphysgrade), 3, 3, 0, shadcolor, shadcolor, shadcolor, shadcolor, shadalph);
            draw_text_transformed_color(320, yy + (mspace * 6) + 10, get_letter_rank(currentphysgrade), 3, 3, 0, _col, _col, c_white, c_white, 1);
            draw_set_font(scr_84_get_font("8bit_mixed"));
        }
    ...
    if (replayversion && boardnumber == 1)
    {
        ...
        if (rtimer > 14)
        {
            draw_set_halign(fa_left);
            draw_set_font(scr_84_get_font("8bit"));
            sp_draw_text(leftx, yy + (mspace * 1), stringsetloc("TALLEST STACK", "obj_round_evaluation_slash_Draw_0_gml_778_0"));
            draw_set_font(scr_84_get_font("8bit_mixed"));
            draw_set_halign(fa_right);
        ...
        if (rtimer > 28)
        {
            draw_set_halign(fa_left);
            draw_set_font(scr_84_get_font("8bit"));
            sp_draw_text(leftx, yy + (mspace * 2), stringsetloc("FOODS WASTED", "obj_round_evaluation_slash_Draw_0_gml_779_0"));
            draw_set_font(scr_84_get_font("8bit_mixed"));
            draw_set_halign(fa_right);
        ...
        if (rtimer > 42)
        {
            draw_set_halign(fa_left);
            draw_set_font(scr_84_get_font("8bit"));
            sp_draw_text(leftx, yy + (mspace * 3), stringsetloc("HAPPY CUSTOMERS", "obj_round_evaluation_slash_Draw_0_gml_780_0"));
            draw_set_font(scr_84_get_font("8bit_mixed"));
            draw_set_halign(fa_right);
        ...
        if (gradecon >= 1)
        {
            ...
            draw_set_font(scr_84_get_font("8bit"));
            draw_set_halign(fa_center);
            draw_text_transformed_color(midx + shadoff, yy + (mspace * 5.5) + shadoff, get_letter_rank(currentphysgrade), 3, 3, 0, shadcolor, shadcolor, shadcolor, shadcolor, shadalph);
            draw_text_transformed_color(midx, yy + (mspace * 5.5), get_letter_rank(currentphysgrade), 3, 3, 0, c_yellow, c_yellow, c_white, c_white, 1);
            draw_set_halign(fa_left);
            draw_set_font(scr_84_get_font("8bit_mixed"));
        }
    ...
    if (!replayversion)
    {
        ...
        if (rtimer > 14)
        {
            ...
            for (var i = 0; i < totalbattles; i++)
                sp_draw_text((midx - offset) + (i * 20), yy + (mspace * 1), get_letter_rank(_battlegrade[i]));
        ...
        if (rtimer > 14)
        {
            ...
            draw_set_color(_col);
            draw_set_font(scr_84_get_font("8bit"));
            sp_draw_text(rightx, yy + (mspace * 1), get_letter_rank(currentbattlegrade));
            draw_set_color(c_white);
            draw_set_font(scr_84_get_font("8bit_mixed"));
        }
        ...
        if (rtimer > 28)
        {
            ...
            draw_set_color(_col);
            draw_set_font(scr_84_get_font("8bit"));
            sp_draw_text(rightx, yy + (mspace * 2), get_letter_rank(currenttotalgrade));
            draw_set_font(scr_84_get_font("8bit_mixed"));
            draw_set_halign(fa_left);
            draw_set_color(c_white);
        }
        ...
        repeat (_rep)
        {
            if (rtimer > 42)
            {
                ...
                draw_set_color(_col);
                draw_set_font(scr_84_get_font("8bit"));
                sp_draw_text(rightx, yy + (mspace * 3), get_letter_rank(currentphysgrade));
                draw_set_font(scr_84_get_font("8bit_mixed"));
                draw_set_color(c_white);
            }
        }
        ...
        if (rtimer > 56)
        {
            if (boardnumber == 1 && extrakeycount > 0)
            {
                ...
                if (extrakeycount == 2)
                    keystring = stringsetloc("EXTRA KEY! x2", "obj_round_evaluation_slash_Draw_0_gml_1379_0");
        ...
        if (rtimer > 140)
        {
            ...
            var rankstring = stringsetsubloc("~1-RANK", get_letter_rank(desiredletter), "obj_round_evaluation_slash_Draw_0_gml_39_0");
            draw_set_font(scr_84_get_font("8bit"));
            draw_set_halign(fa_center);
            draw_set_color(shadcolor);
            draw_set_alpha(shadalph);
            draw_text_transformed(midx + shadoff, yy + (mspace * 7) + 36 + shadoff, stringsetsubloc("~1!!", rankstring, "obj_round_evaluation_slash_Draw_0_gml_40_0"), 2, 2, 0);
            draw_set_color(c_white);
            draw_set_alpha(1);
            var col = 65535;
            draw_text_transformed_color(midx, yy + (mspace * 7) + 36, stringsetsubloc("~1!!", rankstring, "obj_round_evaluation_slash_Draw_0_gml_40_0"), 2, 2, 0, col, col, c_white, c_white, 1);
            draw_set_color(c_white);
            draw_set_font(scr_84_get_font("8bit_mixed"));
        }
