...
// if (!instance_exists(obj_round_evaluation))
//     evaluation_screen = instance_create_depth(0, 0, 0, obj_round_evaluation);
...
transition_to_state = function(arg0, arg1)
{
    ...
    var _letter_grade = evaluation_screen.get_letter_rank(evaluation_screen._lettergrade);
    rank_text = stringsetsubloc("~1-RANK", _letter_grade, "obj_round_evaluation_slash_Draw_0_gml_39_0");
