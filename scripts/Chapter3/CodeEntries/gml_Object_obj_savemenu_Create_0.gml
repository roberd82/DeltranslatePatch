...
if (ossafe_file_exists("dr.ini"))
{
    ...
    name = ini_read_string(scr_ini_chapter(global.chapter, global.filechoice), "Name", name);
...
for (var i = 0; i < 3; i++)
{
    name_file[i] = stringsetloc("Kris", "obj_savemenu_slash_Create_0_gml_75_0");
    level_file[i] = 0;
    love_file[i] = 1;
    time_file[i] = 0;
    roome_file[i] = 0;
    ...
    if (ossafe_file_exists("dr.ini"))
    {
        ...
        name_file[i] = ini_read_string(scr_ini_chapter(global.chapter, i), "Name", name);
