...
foodwasted = 0;
customersfe = 0;
physicalchallengeletter = "C"; // stringsetloc("C-RANK", "obj_round_evaluation_slash_Draw_0_gml_34_0");;
chef_rank_letter = "Z"; // stringsetloc("Z", "obj_round_evaluation_slash_Draw_0_gml_41_0");;
tchefvar = 0;
...
if (i_ex(obj_chefs_game))
{
    ...
    if (obj_chefs_game.t_rank == true)
        chef_rank_letter = "T"; //stringsetloc("T", "obj_round_evaluation_slash_Draw_0_gml_46_0");
...
for (var i = 0; i < 20; i++)
    _battlegrade[i] = "Z"; // stringsetloc("Z", "obj_round_evaluation_slash_Draw_0_gml_41_0");

currenttotalpoints = 0;
currentphyspoints = 0;
currentbattlegrade = stringsetloc("?-RANK", "obj_round_evaluation_slash_Create_0_gml_59_0");
currenttotalgrade = stringsetloc("?-RANK", "obj_round_evaluation_slash_Create_0_gml_59_0");
currentphysgrade = stringsetloc("?-RANK", "obj_round_evaluation_slash_Create_0_gml_59_0");
...
debugbartimer = 0;
debugbarvalue = 5;
debugbarrank = "Z"; // stringsetloc("Z", "obj_round_evaluation_slash_Draw_0_gml_41_0");
