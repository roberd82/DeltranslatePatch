...
if (global.bmenuno == 9 && global.myfight == 0)
{
    ...
    for (i = 0; i < 6; i += 1)
    {
        ...
        var s1_xscale = (200 - charoffset) / s1_width;
    ...
    if (tripticket)
    {
        var croak = stringsetloc("CroakOnX", "scr_monstersetup_slash_scr_monstersetup_gml_2001_0")
        var xstring = stringsetloc("X", "obj_battlecontroller_slash_Draw_0_gml_819_0");
        draw_set_color(c_red);
        var offset = string_width(croak)
        for (var j = string_length(croak); j > 0; j--) {
            offset -= string_width(string_char_at(croak, j))
            if (string_char_at(croak, j) == xstring) {
                break
            }
        }
        
        draw_text(xx + 30 + 30 + offset, yy + 405, xstring);
        draw_set_color(-1);
    }
}
...
if (global.myfight == 0 && global.chapter == 2 && instance_exists(obj_queen_enemy) && (global.bmenuno == 1 || global.bmenuno == 3 || global.bmenuno == 11 || global.bmenuno == 12 || global.bmenuno == 13))
{
    ...
    {
        draw_set_color(c_gray);
        draw_text_ext_transformed(__view_get(e__VW.XView, 0) + 40, __view_get(e__VW.YView, 0) + 407, stringsetloc("Berdly", "obj_battlecontroller_slash_Draw_0_gml_653_0"), 9999, 9999, 1, 1, 0);
        draw_set_color(c_white);
    ...
    {
        draw_set_color(c_gray);
        draw_text_ext_transformed(__view_get(e__VW.XView, 0) + 40, __view_get(e__VW.YView, 0) + 407, stringsetloc("Shield", "obj_queen_enemy_slash_Draw_0_gml_67_0"), 9999, 9999, 1, 1, 0);
        draw_set_color(c_white);
