...
function scr_rhythmgame_draw_combo(arg0)
{
    if (combo > 0)
    {
        ...
        var _combotext_check = (combo > 999) ? "BIG" : combo;
        var xscale = min(3.5, 3.5 * string_width(_combotext_check) / string_width(_combotext))
        draw_text_transformed_color(arg0 + 2, bottomy - 121, _combotext, (combo >= 100) ? xscale : 5, 5, 0, #666666, #666666, #BBBBBB, #BBBBBB, 0.25);
...
{
    var _trackname = [];
    _trackname[0] = stringsetloc("Lightners Live", "scr_rhythmgame_draw_slash_scr_rhythmgame_draw_gml_128_0");
    _trackname[1] = stringsetloc("Soundcheck", "scr_rhythmgame_draw_slash_scr_rhythmgame_draw_gml_129_0");
    _trackname[2] = stringsetloc("Tenna boss", "scr_rhythmgame_draw_slash_scr_rhythmgame_draw_gml_130_0");
    _trackname[3] = stringsetloc("How to play", "scr_rhythmgame_draw_slash_scr_rhythmgame_draw_gml_131_0");
    _trackname[4] = stringsetloc("Board 4", "scr_rhythmgame_draw_slash_scr_rhythmgame_draw_gml_132_0");
    _trackname[5] = stringsetloc("Rude Buster (Boss)", "scr_rhythmgame_draw_slash_scr_rhythmgame_draw_gml_133_0");
    _trackname[6] = stringsetloc("Rude Buster (Vapor)", "scr_rhythmgame_draw_slash_scr_rhythmgame_draw_gml_134_0");
    return _trackname;
}
