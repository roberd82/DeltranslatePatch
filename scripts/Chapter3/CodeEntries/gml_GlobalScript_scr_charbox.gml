        ...
        if (havechar[c] == 1)
        {
            ...
            if (global.fighting == 1)
            {
                ...
                if (obj_battlecontroller.oopsallacts == 1 && (i_ex(obj_rouxls_ch3_enemy) || i_ex(obj_tenna_board4_enemy)))
                {
                    ...
                    var _heartsprite = scr_84_get_sprite("spr_btheart");
                    ...
                    if (spadesuccesscon == 1 && heartsuccesscon == 0)
                    {
                        ...
                        if (spadetelegraphtimer >= 1 && spadetelegraphtimer <= 4)
                        {
                            if (spadefail == true)
                            {
                                _actsprite = scr_84_get_sprite("spr_btact_fail1");
                            }
                            else
                            {
                        ...
                        if (spadetelegraphtimer >= 5 && spadetelegraphtimer <= 8)
                        {
                            if (spadefail == true)
                            {
                                _actsprite = scr_84_get_sprite("spr_btact_fail2");
                            }
                            else
                            {
                        ...
                        if (gc == charpos[c])
                        {
                            repeat (rep)
                            {
                                ...
                                if (y_extra != 4 && rouxlsgridenabled == true)
                                    _actsprite = scr_84_get_sprite("spr_btact_ex");
            ...
            if (c == 0)
            {
                draw_sprite(scr_84_get_sprite("spr_headkris"), global.faceaction[charpos[c]], xx + 13 + xchunk, bpoff + b_offset + mmy[c]);
                draw_sprite(scr_84_get_sprite("spr_bnamekris"), 0, xx + 51 + xchunk, bpoff + b_offset + 3 + mmy[c]);
            }
            
            if (c == 1)
            {
                draw_sprite(scr_84_get_sprite("spr_headsusie"), global.faceaction[charpos[c]], xx + 13 + xchunk, bpoff + b_offset + mmy[c]);
                draw_sprite(scr_84_get_sprite("spr_bnamesusie"), 0, xx + 51 + xchunk, bpoff + b_offset + 3 + mmy[c]);
            }
            
            if (c == 2)
            {
                draw_sprite(scr_84_get_sprite("spr_headralsei"), global.faceaction[charpos[c]], xx + 13 + xchunk, bpoff + b_offset + mmy[c]);
                draw_sprite(scr_84_get_sprite("spr_bnameralsei"), 0, xx + 51 + xchunk, bpoff + b_offset + 3 + mmy[c]);
            }
            
            if (c == 3)
            {
                draw_sprite(scr_84_get_sprite("spr_headnoelle"), global.faceaction[charpos[c]], xx + 13 + xchunk, bpoff + b_offset + mmy[c]);
                draw_sprite(scr_84_get_sprite("spr_bnamenoelle"), 0, xx + 51 + xchunk, bpoff + b_offset + 3 + mmy[c]);
            }
            
            draw_sprite(scr_84_get_sprite("spr_hpname"), 0, xx + 109 + xchunk, bpoff + b_offset + 11 + mmy[c]);
