...
if (drawchar == 1)
{
    ...
    if (deschaver == 0)
    {
        ...
        draw_text(xx + 500, ((yy + tp) - 60) + ymod, string_hash_to_newline(stringsetsubloc("D$ ~1", string(global.gold), "obj_darkcontroller_slash_Draw_0_gml_47_0")));
        
        if (ymod != 0)
            draw_text(xx + 500, ((yy + tp) - 32) + ymod, string_hash_to_newline(stringsetsubloc("PTs ~1", string(global.flag[1044]), "obj_darkcontroller_slash_Draw_0_gml_58_0")));
    }
}
    ...
    if (charcoord == 2)
    {
        ...
        if (global.chapter == 3)
        {
            ...
            else
            {
                ...
                var str = stringsetloc("Plucked", "obj_darkcontroller_slash_Draw_0_gml_552_0")
                xx_scale = min(1, 122 / string_width(str));
                draw_text_transformed(xx + 100, ch_y[4], str, xx_scale, 1, 0);
