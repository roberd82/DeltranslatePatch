...
init = function(arg0 = "susiezilla")
{
    ...
    else if (game_type == "band")
    {
        ...
        game_room = room_dw_rhythm_countdown;
    }
    else
    {
    ...
    var poster_sprite = spr_dw_poster_locked;
    
    if (_is_unlocked)
    {
        if (arg0 == "chef")
        {
            poster_sprite = scr_84_get_sprite("spr_dw_poster_chef");
        }
        else if (arg0 == "band")
        {
            poster_sprite = scr_84_get_sprite("spr_dw_poster_band");
        }
        else if (arg0 == "susiezilla")
        {
            if (scr_flag_get(1219) > 0)
                poster_sprite = spr_dw_teevie_poster_susiezilla;
        }
    }
