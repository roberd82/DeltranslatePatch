...
else if (mode == 1)
{
    ...
    if (quiz_intro)
    {
        ...
        draw_text_transformed(_tx + 2, _ty, string_hash_to_newline(quizstring), str_scale * _scale, str_scale * _scale, 0);
        draw_set_color(c_white);
        draw_set_alpha(1);
        draw_set_color(c_white);
        draw_text_transformed(_tx, _ty, string_hash_to_newline(quizstring), str_scale * _scale, str_scale * _scale, 0);
    ...
    else if (quiz_display)
    {
        ...
        if (answer == let_a)
        {
            ...
            {
                draw_set_color(dblue);
                draw_text_ext_transformed(x + 90, y + 90 + 2, let_a, 999, 999, 2, 2, 0);
                draw_text_ext_transformed(x + 90 + 2, y + 90 + 2, let_a, 999, 999, 2, 2, 0);
                draw_text_ext_transformed(x + 90 + 2, y + 90, let_a, 999, 999, 2, 2, 0);
                draw_set_color(_answer_color);
                draw_set_alpha(1);
                draw_text_ext_transformed(x + 90, y + 90, let_a, 999, 999, 2, 2, 0);
            }
            
            if (ralsei_select)
            {
                draw_set_color(dblue);
                draw_text_ext_transformed(x + 150, y + 90 + 2, let_a, 999, 999, 2, 2, 0);
                draw_text_ext_transformed(x + 150 + 2, y + 90 + 2, let_a, 999, 999, 2, 2, 0);
                draw_text_ext_transformed(x + 150 + 2, y + 90, let_a, 999, 999, 2, 2, 0);
                draw_set_color(_answer_color);
                draw_set_alpha(1);
                draw_text_ext_transformed(x + 150, y + 90, let_a, 999, 999, 2, 2, 0);
            }
        }
        
        draw_set_color(dblue);
        draw_text_ext_transformed(x + 120, y + 90 + 2, let_a, 999, 999, 2, 2, 0);
        draw_text_ext_transformed(x + 120 + 2, y + 90 + 2, let_a, 999, 999, 2, 2, 0);
        draw_text_ext_transformed(x + 120 + 2, y + 90, let_a, 999, 999, 2, 2, 0);
        draw_set_color(_answer_color);
        draw_set_alpha(1);
        draw_text_ext_transformed(x + 120, y + 90, let_a, 999, 999, 2, 2, 0);
        draw_set_font(scr_84_get_font("8bit_mixed"));
        draw_set_color(dblue);
        ...
        if (answer == let_b)
        {
            ...
            {
                draw_set_color(dblue);
                draw_text_ext_transformed(x + 330, y + 90 + 2, let_b, 999, 999, 2, 2, 0);
                draw_text_ext_transformed(x + 330 + 2, y + 90 + 2, let_b, 999, 999, 2, 2, 0);
                draw_text_ext_transformed(x + 330 + 2, y + 90, let_b, 999, 999, 2, 2, 0);
                draw_set_color(_answer_color);
                draw_set_alpha(1);
                draw_text_ext_transformed(x + 330, y + 90, let_b, 999, 999, 2, 2, 0);
            }
            
            if (ralsei_select)
            {
                draw_set_color(dblue);
                draw_text_ext_transformed(x + 390, y + 90 + 2, let_b, 999, 999, 2, 2, 0);
                draw_text_ext_transformed(x + 390 + 2, y + 90 + 2, let_b, 999, 999, 2, 2, 0);
                draw_text_ext_transformed(x + 390 + 2, y + 90, let_b, 999, 999, 2, 2, 0);
                draw_set_color(_answer_color);
                draw_set_alpha(1);
                draw_text_ext_transformed(x + 390, y + 90, let_b, 999, 999, 2, 2, 0);
            }
        }
        
        draw_set_color(dblue);
        draw_text_ext_transformed(x + 360, y + 90 + 2, let_b, 999, 999, 2, 2, 0);
        draw_text_ext_transformed(x + 360 + 2, y + 90 + 2, let_b, 999, 999, 2, 2, 0);
        draw_text_ext_transformed(x + 360 + 2, y + 90, let_b, 999, 999, 2, 2, 0);
        draw_set_color(_answer_color);
        draw_set_alpha(1);
        draw_text_ext_transformed(x + 360, y + 90, let_b, 999, 999, 2, 2, 0);
        draw_set_font(scr_84_get_font("8bit_mixed"));
        draw_set_color(dblue);
    ...
    if (bullet_mode)
    {
        ...
        if (bullet_con == 0)
        {
            ...
            bullet_screen_sprite = spr_dw_teevie_red_x;
        }
