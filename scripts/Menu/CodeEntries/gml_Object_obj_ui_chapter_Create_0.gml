...
init = function(arg0, arg1)
{
    ...
    var chapter_text = scr_get_lang_string("Chapter ", "gml_Object_obj_ui_chapter_Create_0_0") + string(_chapter);
    ...
    _chapter_choice.set_font(_font);
    _chapter_choice.set_alpha(0);
    var play_text = scr_get_lang_string("Play", "gml_Object_obj_ui_chapter_Create_0_1");
    var cancel_text = scr_get_lang_string("Do Not", "gml_Object_obj_ui_chapter_Create_0_2");
