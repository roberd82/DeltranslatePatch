        ...
        for (i = 0; i < 3; i += 1)
        {
            ...
            if (global.monster[i] == 1)
            {
                ...
                if (tireddraw == 1)
                {
                    ...
                    draw_sprite(scr_84_get_sprite("spr_tiredmark"), 0, xx + 80 + namewidth + 40, yy + 385 + (i * 30));
                }
...
if (global.bmenuno == 2 && global.myfight == 0)
{
    ...
    draw_text(xx + spell_offset, yy + 440, string_hash_to_newline(string(thiscost) + scr_84_get_lang_string("obj_battlecontroller_slash_Draw_0_gml_171_0"))); // % TP
}
...
if (global.bmenuno == 9 && global.myfight == 0)
{
    ...
    if (global.tensionselect > 0)
    {
        ...
        draw_set_color(c_orange);
        draw_text(xx + 500, yy + 440, string_hash_to_newline(string(thiscost) + scr_84_get_lang_string("obj_battlecontroller_slash_Draw_0_gml_280_0"))); // % TP
    }
