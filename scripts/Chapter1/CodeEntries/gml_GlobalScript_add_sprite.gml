function add_sprite(argument0, argument1) //gml_Script_add_sprite
{
    ...
    var frame_num = 0
    var filename = global.lang_folder + global.lang + "/chapter1/sprites/" + spr_name + ".png"
    if file_exists(filename)
    {
        ...
        var sp_filename = global.lang_folder + global.lang + "/chapter1/sprites/sp_" + spr_name + ".png"
